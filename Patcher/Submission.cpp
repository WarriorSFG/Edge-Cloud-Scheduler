...
static void loadKnobs() {
    ...
    KN_CHUNK_SMULT  = envd("V4_CHUNK_SMULT", 402.59307099937456);
    KN_HOLD         = envi("V4_HOLD", 0);
    KN_WAVES        = envd("V4_WAVES", 62.66615710608102);
    KN_HOLD_WFRAC   = envd("V4_HOLD_WFRAC", 0.8226005606596583);
    KN_HOLD_SMULT   = envd("V4_HOLD_SMULT", 17.95385816532776);
    KN_UPGATE_FRAC  = envd("V4_UPGATE_FRAC", 0.3601906414112629);
    KN_UPPRE_MAX    = envi("V4_UPPRE_MAX", 4);
    KN_UPPRE_MAX_TP = envi("V4_UPPRE_MAX_TP", 19);
    KN_RATE_EFF     = envd("V4_RATE_EFF", 0.13578990752536593);
    KN_DECW         = envd("V4_DECW", 2.140771638492257);
    KN_WAVES_PROC   = envi("V4_WAVES_PROC", 0);
    KN_LATHOLD      = envi("V4_LATHOLD", 0);
    KN_LATFRAC      = envd("V4_LATFRAC", 0.5222432600548044);
    KN_CONS         = envi("V4_CONS", 1);
    KN_CONS_PEN     = envd("V4_CONS_PEN", 2545.960832265);
    KN_CHUNK_MINS   = envd("V4_CHUNK_MINS", 381.66013927580383);
    KN_CHUNK_TPP    = envd("V4_CHUNK_TPP", 1.4095971852660905);
    KN_BASE_W       = envd("V4_BASE_W", 910.901071148655);
    KN_B_DPOST      = envd("V4_B_DPOST", 48.80467793339546);
    KN_B_PPOST      = envd("V4_B_PPOST", 6.243974144784224);
    KN_B_DPRE       = envd("V4_B_DPRE", 10.880987970990507);
    KN_B_PPRE       = envd("V4_B_PPRE", 62.184277960039296);
    KN_B_DPROC      = envd("V4_B_DPROC", 22.24991429995628);
    KN_B_PPROC      = envd("V4_B_PPROC", 26.674902389914784);
    ...
    KN_AGE_FLOOR    = envd("V4_AGE_FLOOR", 1.4027490804614926);
    KN_AGE_AW       = envd("V4_AGE_AW", 0.44651757519109275);
    KN_AGE_PRESS    = envd("V4_AGE_PRESS", 9.630219305311458);
    KN_AGE_SLO_W    = envd("V4_AGE_SLO_W", 8.376203193070838);
    KN_AGE_NORM     = envi("V4_AGE_NORM", 0);
    KN_PPRE_AGECAP  = envd("V4_PPRE_AGECAP", 318001.36315255414);
    KN_DECQ         = envd("V4_DECQ", 21.669448385015592);
    KN_CHUNK_RATIO  = envd("V4_CHUNK_RATIO", 26.55125855808814);
    KN_CHUNK_PRED   = envi("V4_CHUNK_PRED", 1);
    KN_LAT_MULT     = envd("V4_LAT_MULT", 5.446841306104119);
    KN_GATE_TDR     = envd("V4_GATE_TDR", 0.824363361221876);
    KN_HOLD_ACT     = envi("V4_HOLD_ACT", 2);
    KN_HOLD_AW      = envd("V4_HOLD_AW", 0.7699935530986108);
